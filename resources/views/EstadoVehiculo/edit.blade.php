...
@section('title', 'Editar Estado Vehículo')

@section('content')
        <legend>Editar estado de vehículo</legend>
        
<form class="form-horizontal" method="post" action="{{ route('estadoVehiculo.updateStatus',$estados->id) }}">
{{ csrf_field() }}
<fieldset>
