...
@section('title', 'Nuevo Estado Vehículo')

@section('content')
<legend>Crear nuevo estado de vehículo</legend>
        
<form class="form-horizontal" method="POST" action="{{ route('estadoVehiculo.storeStatus') }}">
{{ csrf_field() }}
<fieldset>
